...
class ConfusionMatrix:
    ...
    def process_batch_wei(self, detections, labels):
        """
        ...
        gt_classes = labels[:, 0:n_att].int()
        detection_classes = detections[:, 5:5+n_att].int()
        iou = general.box_iou(labels[:, n_att:], detections[:, :4])
